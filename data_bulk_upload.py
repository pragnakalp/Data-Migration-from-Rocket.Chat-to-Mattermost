...
database_path='<Provide your databse path>'
...
def save_file_from_gridfs(file_id):
    ...
    db = client['<Name of your database>']
...
if __name__ == '__main__':
    ...
    for field in fields.keys():
        with open(f'{database_path}/dump/parties/{field}.bson', 'rb') as f:
    ...
    jsonl = [
        ...
        json.dumps(dict(
            type='team',
            team=dict(
                name='<Name of your channel>',
                display_name='<Name of your channel>',
                type='O',
            ),
        )),
    ]
